...
using MyCode.Viewports.TwitterApi.Models;
...
using TaskExtensions = MyCode.Viewports.Api.Background.Tasks.Extensions.TaskExtensions;
using MyCode.Viewports.TwitterApi.Services.TweetObjects;
using MyCode.Viewports.Api.Extensions;
using MyCode.Viewports.Api.Hubs.Extensions;
using MyCode.Viewports.Api.Configuration;

namespace MyCode.Viewports.Api.Background.Tasks
{
    /// <summary>
